...
BOS_LOGO_URL = "https://raw.githubusercontent.com/ajaymallepogu-5yince/jira_nps_automation/main/bos-tm-white-revised.png"
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="vertical-align:middle;width:140px;">
                    <img src="{BOS_LOGO_URL}" alt="BOS" width="130" style="display:block;" />
                  </td>

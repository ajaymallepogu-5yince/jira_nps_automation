    ...
    <tr>
      <td align="center">
        <table width="620" cellpadding="0" cellspacing="0"
          ...
          <!-- HEADER — logo + project name, no subtitle -->
          <tr>
            <td style="padding:28px 36px 22px;border-bottom:2px solid {BRAND_COLOR};">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="vertical-align:middle;width:60px;">
                    <img src="data:image/png;base64,{BOS_LOGO_B64}" alt="BOS" width="52" style="display:block;" />
                  </td>
                  <td style="padding-left:14px;vertical-align:middle;">
                    <div style="font-size:19px;font-weight:bold;
                                color:{BRAND_COLOR};letter-spacing:2px;">
                      {project_name}
                    </div>
                  </td>
                </tr>
